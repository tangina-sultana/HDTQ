 ...
 *
 */
public class SequentialSearchIteratorQuadID extends SequentialSearchIteratorTripleID {
	
	public SequentialSearchIteratorQuadID(QuadID pattern, IteratorTripleID other) {
		super();
		this.pattern = pattern;
		this.iterator = other;
		hasPreviousTriples = false;
		goingUp = true;
		nextTriple = new QuadID();
		returnTriple = new QuadID();
		doFetchNext();
	}
